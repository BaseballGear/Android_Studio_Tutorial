...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemClickListener {
    ...
    {
        mainTextView.setText(mainEditText.getText().toString() + " is learning android development wowow!");
    ...
    private void queryBooks(String searchString)
    {
        ...
        client.get(QUERY_URL + urlString, new JsonHttpResponseHandler()
        {
            ...
            public void onFailure(int statusCode, Throwable throwable, JSONObject error)
            {
                ...
                Log.e("hello world", statusCode + " " + throwable.getMessage());
            }
        });

        // update the data in your custom method.
        // remove comment eventually to fix error: mJSONAdapter.updateData(jsonObject.optJSONArray("docs"));
    }
}
